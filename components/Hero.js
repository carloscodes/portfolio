    ...
    return (
        <>
            <Container className="text-left m-16">
                ...
                <Text fontSize='xs' className="text-gray-400 mb-12">I'm a software engineer specializing in building (and on occasions, desigining) exceptional digital experiences. Currently, I'm focused on building an accessible, human-centered product to get people healthy and thriving. </Text>
